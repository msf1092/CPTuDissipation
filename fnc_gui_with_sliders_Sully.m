function [u0_sqrt, u_max, t_50, u_50] = fnc_gui_with_sliders_Sully(x,y,y0,x1_min,x1_max,y1_min,y1_max,x2_min,x2_max,y2_min,y2_max,test_depth)
...
% Callback to finish adjustments and save results
    function finishCallback()
        ...
        hold on;
        plot(x, y, 'LineStyle', '-', 'LineWidth',1.5, 'Color','k', 'DisplayName', sprintf('$d=$ %0.2f m', test_depth));
        ...
        text(0, y0, '$u_{0}$', 'Interpreter', 'latex', 'FontSize', 9, ...
            'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'Color', 'blue');
        text(t_50^0.5, u_50, sprintf('\\hspace {0.2cm}$t_{50}$=%0.2f sec',t_50), 'Interpreter', 'latex', 'FontSize', 9, ...
